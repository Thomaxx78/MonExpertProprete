...
<body class="font-Inter">
    ...
    <main class="xl:m-24">
        <div class="lg:flex lg:items-center lg:mt-16 sm:flex">
            <div class="flex-col mt-16 ml-4 lg:ml-16 sm:ml-8">
                ...
                <div class="flex items-center mt-6 gap-4">
                    <a href="#" class="bg-gen-blue hover:bg-blue-900 text-white font-bold  border-2 border-gen-blue px-3 py-1 rounded lg:py-4 lg:w-4/12 lg:text-xl lg:text-center">Télécharger</a>
                    <a href="https://youtu.be/MlVqW59m3HU" class="text-gen-blue hover:bg-gen-blue hover:text-white font-bold  border-2 border-gen-blue px-3 py-1 rounded lg:py-4 lg:w-4/12 lg:text-xl lg:text-center">Voir la démo</a>
                </div>
            </div>
        ...
        <div class="lg:flex lg:items-center lg:justify-center lg:space-x-8 sm:ml-8">
            ...
            <div class="flex-column ml-4 mt-12 lg:w-6/12 lg:ml-0 sm:ml-0">
                ...
                <div class="flex mt-6 items-center">
                    ...
                    <span class="font-bold lg:text-2xl ">Trouve des conseils pour bien choisir tes produits</span>
                </div>
                ...
                <div class="flex mt-6 items-center">
                    ...
                    <span class="font-bold lg:text-2xl ">Sauvegarde tes produits préférés</span>
                </div>
        ...
        <div class="ml-4 mt-8 mr-4 flex-column lg:mt-16 lg:ml-16 sm:ml-8 sm:mt-16 lg:mb-16">
            ...
            <div class="flex flex-col lg:grid lg:grid-cols-2 mt-8">
                <?php
                    ...
                    foreach($all_questions as $question){?>
                        <div class="questionFAQ lg:w-12/12 p-4 lg:p-6">
