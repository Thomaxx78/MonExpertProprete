...
<nav class="relative px-4 py-4 flex justify-between items-center bg-white lg:mt-4">
			<a href="" class=" lg:ml-8 lg:mr-auto"><img src="public/logo.png" class="lg:h-12" alt=""></a>
		...
		<ul class="hidden  lg:flex lg:gap-10 lg:items-center">
                <li class="block p-4 text-2xl font-semi-bold"><a href="gestion.php?gestion=faq" <?php if($gestion=="question"){echo 'class=""';}?>>Modifier la faq</a></li>
                <li class="block p-4 text-2xl font-semi-bold"><a href="gestion.php?gestion=blog" <?php if($gestion=="article"){echo 'class=""';}?>>Modifier le blog</a></li>
                <li><a href="deco.php" class=" rounded text-gen-blue border-solid border-2 border-gen-blue ml-auto mr-4 text-center px-2 py-1 font-semi-bold lg:mr-8 lg:px-4 lg:py-2 lg:text-2xl sm:mr-8">Déconnexion</a></li>
            </ul>
	</nav>
		...
		<nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm pt-6 px-6 bg-white border-r overflow-y-auto">
			...
			<div>
				<ul>
                    ...
                    <li class="mb-1">
                        <a href="deco.php" class="text-2xl text-gen-blue rounded border-solid border-2 border-gen-blue px-2 py-1 ml-4">Déconnexion</a>
                    </li>
				</ul>
			</div>
			<div class="mt-auto">
