<header class="font-Inter mt-28">
	<nav class="fixed top-0 left-0 w-full px-4 py-4 flex justify-between items-center bg-white bg-opacity-60 backdrop-blur-md">
		...
		<ul class="hidden  lg:flex lg:gap-10">
			...
			<li><a href="#" class="download bg-gen-blue hover:bg-blue-800 rounded text-white ml-auto mr-4 text-center px-4 py-2 font-bold lg:mr-16 lg:px-5 lg:py-3 lg:text-2xl sm:mr-8">Télécharger</a></li>
		</ul>
	</nav>
