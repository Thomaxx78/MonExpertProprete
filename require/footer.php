<div class="flex w-12/12 mt-8 bg-gen-blue lg:h-auto">
        <div class="flex-col ml-4 items-center pb-2">
            <img src="public/logoblanc.png" alt="Logo de Mon Expert Propreté" class="h-10 lg:h-16">
            <div class="flex-col lg:flex-col">
                <div class= "flex text-white gap-2 mt-2 text-sm text-center lg:text-2xl  lg:text-start lg:font-bold lg:flex-col">
                ...
                <div class="flex mt-4 items-center lg:flex-col">
                    ...
                    <div class="flex h-4 gap-2 mr-4 ml-auto lg:h-8">
                        ...
                        <img src="public/snap.png" alt="Snapchat">
                        <img src="public/insta.png" alt="Instagram">
                        <img src="public/tumblr.png" alt="Trumblr">
                    </div>
                </div>
            </div>
        </div>
