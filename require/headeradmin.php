...
<nav class="relative px-4 py-4 flex justify-between items-center bg-white lg:mt-4">
			<a href="index.php" class=" lg:ml-8 lg:mr-auto"><img src="public/logo.png" class="lg:h-12" alt="Logo de Mon Expert Propreté"></a>
		...
		<ul class="hidden  lg:flex lg:gap-10 lg:items-center">
                ...
                <li><a href="database/deco.php" class=" rounded text-gen-blue border-solid border-2 border-gen-blue ml-auto mr-4 text-center px-2 py-1 font-semi-bold lg:mr-8 lg:px-4 lg:py-2 lg:text-2xl sm:mr-8">Déconnexion</a></li>
            </ul>
	</nav>
